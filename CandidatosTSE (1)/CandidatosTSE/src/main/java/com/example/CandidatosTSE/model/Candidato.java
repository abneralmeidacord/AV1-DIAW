 ...
 * Somente os campos usados na tela estão mapeados; o CSV tem muitas outras
 * colunas.
 */
public class Candidato {
    ...
    private String nrCpfCandidato; // NR_CPF_CANDIDATO -> usado para agrupar candidaturas da mesma pessoa
                                   // (titular/suplente)
